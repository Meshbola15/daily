...
const Hero = () => {
  ...
  const tabParaghapStyles = "text-md lg:text-lg";

  return (
    <div className="w-full min-h-screen gradient-background px-10 py-10 lg:px-28 lg:py-5">
      <h2 className="text-white  text-[25px] lg:text-[40px] font-bold mb-5">
        Daily
      </h2>
      <div className="flex items-center justify-between flex-col lg:flex-row w-full">
        <div className="text-white text-center mt-0 lg:-mt-[35vh] mr-0 lg:mr-10 lg:w-[50vw] lg:text-left w-full">
          ...
          <a
            ...
            className="px-[20px] py-[10px] bg-white text-black font-medium rounded-[15px] text-md"
          >
            Join the Waitlist
          </a>
        </div>
        <img
          src={Iphone}
          alt="Image"
          className=" mt-12 h-auto w-full lg:h-[120vh] lg:w-auto lg:mt-0 mr-0 pr-0"
        />
        {/* <img src="" alt="" class /> */}
      </div>
      ...
      <div className="my-20 lg:min-h-screen flex items-center flex-col lg:flex-row justify-between">
        <div className="flex items-start w-full lg:w-1/2 justify-start flex-col">
          <div className="items-start flex flex-row justify-start mb-4">
            <img
              src={bitcoinExchange}
        ...
        <img
          src={App}
          alt="App"
          className="w-full mt-10 lg:mt-0 md:w-[50vw] ml-0 lg:h-[110vh] lg:w-auto"
        />
      </div>
    </div>
  );
